...
<div id="dialog-aclModule-form" style="display: none;">
    <form id="aclModuleForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            <tr>
                <td style="width: 80px;"><label for="parentId">Parent Module</label></td>
                <td>
...
<div id="dialog-acl-form" style="display: none;">
    <form id="aclForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            <tr>
                <td style="width: 80px;"><label for="parentId">Associated Permission Module</label></td>
                <td>
    ...
    $(function() {
            ...
            $.ajax({
                ...
                success : function (result) {
                    if(result.ret) {
                        ...
                        showMessage("Load Permission Modules", result.msg, false);
                    }
                }
            })
        }
                ...
                buttons : {
                    "Add": function(e) {
                        ...
                        updateAclModule(true, function (data) {
                            ...
                            showMessage("Add Permission Module", data.msg, false);
                        })
                    },
                    "Cancel": function () {
                        $("#dialog-aclModule-form").dialog("close");
        ...
        function bindAclModuleClick() {
            ...
            $(".aclModule-delete").click(function (e) {
                ...
                if (confirm("Are you sure you want to delete permission module  [" + aclModuleName + "]吗?")) {
                    $.ajax({
                        ...
                        success: function (result) {
                            if (result.ret) {
                                showMessage("Delete Permission Module  [" + aclModuleName + "]", " Operation Successful ", true);
                                loadAclModuleTree();
                            } else {
                                showMessage("Delete Permission Module  [" + aclModuleName + "]", result.msg, false);
                            }
                        }
                    });
                }
                    ...
                    buttons : {
                        "Update": function(e) {
                            ...
                            updateAclModule(false, function (data) {
                                ...
                                showMessage("Edit Permission Module", data.msg, false);
                            })
                        },
                        "Cancel": function () {
                            $("#dialog-aclModule-form").dialog("close");
            ...
            if(result.ret) {
                if (result.data.total > 0){
                    var rendered = Mustache.render(aclListTemplate, {
                        ...
                        "showType": function() {
                            return this.type == 1 ? "Menu" : (this.type == 2 ? "Button" : "Other");
                        },
                        "bold": function() {
                            return function(text, render) {
                ...
                showMessage("Get Permission List", result.msg, false);
            }
        }
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        if (result.ret) {
                            ...
                            showMessage("Get all users and roles associated with this permission.", result.msg, false);
                        }
                    }
                })
            });
