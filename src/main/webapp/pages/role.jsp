...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            Manage Role–User and Role–Permission Associations
        </small>
    </h1>
</div>
        ...
        <div class="tabbable" id="roleTab">
            ...
            <div class="tab-content">
                ...
                <div id="roleUserTab" class="tab-pane fade" >
                    <div class="row">
                        <div class="box1 col-md-6">Available Users</div>
...
<script type="text/javascript">
    $(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        ...
                        showMessage("Load Roles", result.msg, false);
                    }
                }
            });
        }
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        ...
                        showMessage("Load Role Permission Data", result.msg, false);
                    }
                }
            });
        }
                ...
                buttons : {
                    "Add": function(e) {
                        ...
                        updateRole(true, function (data) {
                            ...
                            showMessage("Create Role", data.msg, false);
                        })
                    },
                    "Cancel": function () {
                        $("#dialog-role-form").dialog("close");
        ...
        $(".saveRoleAcl").click(function (e) {
            e.preventDefault();
            if (lastRoleId == -1) {
                showMessage("Save Role–Permission Relationship", "Please select a role from the left panel before performing actions.", false);
                return;
            }
            $.ajax({
        ...
        $("#roleTab a[data-toggle='tab']").on("shown.bs.tab", function(e) {
            if(lastRoleId == -1) {
                showMessage("Load role relationships","Please select a role from the left panel before performing actions.", false);
                return;
            }
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        ...
                        showMessage("Load the role user data", result.msg, false);
                    }
                }
            });
        }
        ...
        $(".saveRoleUser").click(function (e) {
            e.preventDefault();
            if (lastRoleId == -1) {
                showMessage("Saved Role–Permission Relationship", "Please select a role from the left panel first", false);
                return;
            }
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        showMessage("Saved Role–Permission Relationship", "Operation Success", false);
                    } else {
                        showMessage("Saved the relationship between roles and users", result.msg, false);
                    }
                }
            });
        });
