...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            Track Updates for Permission Modules.
        </small>
    </h1>
</div>
                            ...
                            <div class="dataTables_length" id="dynamic-table_length"><label>
                                ...
                                <label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类型
                                    <select id="search-type" name="dynamic-table_length" aria-controls="dynamic-table" class="form-control input-sm">
                                        ...
                                        <option value="6">Role-Permission Relationship</option>
                                        <option value="7">Role-User Relationship</option>
                                    </select></label>
        ...
        $(function () {
            ...
            function renderLogListAndPage(result, url) {
                if (result.ret) {
                            ...
                            "showType": function () {
                                return function (text, render) {
                                    ...
                                    switch (this.type) {
                                        ...
                                        case 3: typeStr = "Permission Module";break;
                                        case 4: typeStr = "Permission";break;
                                        case 5: typeStr = "Role";break;
                                        case 6: typeStr = "Role-Permission Relationship";break;
                                        case 7: typeStr = "Role-User Relationship";break;
                    ...
                    showMessage("Retrieve Permission Operation History", result.msg, false);
                }
            }
            ...
            function bindLogClick() {
                $(".log-edit").click(function (e) {
                    ...
                    console.log(logId);
                    if (confirm("Are you sure you want to restore this operation?")) {
                        $.ajax({
                            ...
                            success: function (result) {
                                if (result.ret) {
                                    showMessage("Restore History Record", "Operation Completed Successfully.", true);
                                    loadLogList();
                                } else {
                                    showMessage("Restore History Record", result.msg, false);
                                }
                            }
                        });
                    }
